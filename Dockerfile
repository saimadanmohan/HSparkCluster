...
#RUN wget http://apache.claz.org/tez/0.9.0/apache-tez-0.9.0-src.tar.gz https://github.com/google/protobuf/releases/download/v2.5.0/protobuf-2.5.0.tar.gz
...
#RUN rm apache-tez-0.9.0-src.tar.gz protobuf-2.5.0.tar.gz
